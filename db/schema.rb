...
ActiveRecord::Schema.define(version: 2019_10_03_055250) do
  ...
  create_table "comments", id: :serial, force: :cascade do |t|
    ...
    t.index ["estate_id"], name: "index_comments_on_estate_id"
    t.index ["user_id", "estate_id"], name: "index_comments_on_user_id_and_estate_id"
  end
